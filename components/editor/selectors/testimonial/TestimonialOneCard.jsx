      ...
      {isLoading && (
        <div className="col-span-12 animate-pulse select-none md:col-span-6 lg:col-span-4">
          <div className="h-full text-center">
            <div className="mb-6 inline-block h-20 w-20 rounded-full border-2 border-gray-200 bg-gray-200 object-cover object-center" />
            <p className="bg-gray-200 leading-relaxed text-gray-200">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
              eiusmod tempor incididunt ut labore et dolore magna aliqua.
            </p>
            <span className="mt-6 mb-4 inline-block h-1 w-10 rounded bg-gray-200"></span>
            <h2 className="title-font bg-gray-200 text-sm font-medium uppercase tracking-wider text-gray-200">
              Tempor Incididunt
            </h2>
            <p className="bg-gray-200 text-sm text-gray-200">
