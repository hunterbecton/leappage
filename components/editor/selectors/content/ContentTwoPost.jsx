        ...
        <div className="-my-8 animate-pulse select-none divide-y-2 divide-gray-100">
          <div className="flex flex-wrap py-8 md:flex-nowrap">
            <div className="mb-6 flex flex-shrink-0 flex-col md:mb-0 md:w-64">
              <span className="max-w-fit bg-gray-200 text-sm font-bold uppercase text-gray-200">
                Lorem Ipsum
              </span>
            </div>
            <div className="md:flex-grow">
              <h2 className="mb-2 bg-gray-200 text-2xl font-medium leading-tight text-gray-200">
              ...
              <p className="group mt-4 inline-flex items-center bg-gray-200 text-gray-200">
                Read More
                <svg
