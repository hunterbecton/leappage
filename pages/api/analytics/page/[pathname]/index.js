...
// Get site analytics for a path
handler.get(async (req, res, next) => {
  // Get items from req.query
  const filteredQuery = filterObject(req.query, 'last', 'pathname');
  ...
  let fetchRoute = `https://api.usefathom.com/v1/aggregations?entity=pageview&entity_id=ACPBVJGZ&aggregates=visits,uniques,pageviews,avg_duration&filters=${filters}&date_from=${thirtyDaysAgo}&date_to=${now}`;
